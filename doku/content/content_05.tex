...
In diesem Kapitel wird beschrieben, wie die Backend Komponente sowie die zwei Frontend Komponenten, eine iOS App sowie ein Web Admin-Dashboard als Referenz Implementierung entwickelt werden. 
