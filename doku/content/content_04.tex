...
Die erste Option zur Entwicklung des Frontends besteht darin, dass eine zusammenfassende Anwendung entwickelt wird, welches die beiden Hauptfunktionen vereint. Hierbei können sich die Endkunden die Backprodukte anzeigen lassen und der Administrator, nachdem er sich nach der nichtfunktionalen Anforderung \ref{nfa10} authentifiziert hat, die Daten pflegen. Dies ließe sich mittels einer nativen iOS App realisieren.
...
Trotz des erhöhten Aufwands zur Entwicklung fällt die Entscheidung auf die zweite Option, die Entwicklung einer iOS App für die Endkunden und einer Webseite zur Administration der Daten.