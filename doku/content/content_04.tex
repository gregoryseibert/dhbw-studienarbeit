...
Um dies zu verhindern, wurde \gls{http} um einen SSL/TLS-Layer erweitert, was als HTTPS bezeichnet wird.
...
\abbildungs{8cm}{images/content/ssl-tls.png}{SSL und TLS Unterstützung von Webservern \cite{ssl-tls}}{ssl-tls}
