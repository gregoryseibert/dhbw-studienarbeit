...
class BunDetailViewController: UIViewController {
    ...
    private lazy var textWeight: UITextView = createTextViewWithHeader(header: NSLocalizedString("bakedgood_weight", comment: ""), content: bun!.getWeightAsString())
    
    private lazy var textNutrients: UITextView = createTextViewWithHeader(header: NSLocalizedString("bakedgood_nutrients", comment: ""), content: bun!.getNutrientsAsString())
    
    private lazy var textCharakteristic = createTextViewWithHeader(header: NSLocalizedString("bakedgood_characteristic", comment: ""), content: bun!.characteristic)
    
    private lazy var textCerealMix: UITextView = createTextViewWithHeader(header: NSLocalizedString("bakedgood_cerealmix", comment: ""), content: bun!.getCerealMixAsString())
    
    private lazy var textIngredients: UITextView = createTextViewWithHeader(header: NSLocalizedString("bakedgood_ingredients", comment: ""), content: bun!.getIngredientsAsString())
    ...
    func setData(item: Bun, image: UIImage) {
        self.bun = item
    ...
    private func setupConstraints() {
        ...
        if traitCollection.horizontalSizeClass == .compact {
            ...
            constrainCenteredViewBelowTo(targetView: textNutrients, upperView: textWeight)
            ...
            constrainViewBelowTo(targetView: textNutrients, upperView: textWeight)
